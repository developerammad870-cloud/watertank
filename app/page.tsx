import SiteBehavior from './ui/site-behavior'
...
const jsonLd = {
  ...
  "@type": "LocalBusiness",
  "name": "Sewerage Water Tank — الشفط میاں مجاری",
  "url": SITE_URL,
  ...
  "address": [
    {
      "@type": "PostalAddress",
      "addressLocality": "Mahbellah Saniya",
      "addressRegion": "Muscat",
      "addressCountry": "OM"
    },
    {
      "@type": "PostalAddress",
      "addressLocality": "Al Khoud",
      "addressRegion": "Muscat",
      "addressCountry": "OM"
    }
  ],
              ...
              <div className="hero-grid">
                ...
                <div className="hero-copy">
                  ...
                  <div className="hero-top">
                    ...
                    <p className="eyebrow">
                      {" "}
                      <span className="en">
                        {"Sewage suction · Septic tank emptying"}
                      </span>
                      {" "}
                      <span className="ar">
                        {"شفط مياه المجاري · تفريغ البيارات"}
                      </span>
                      {" "}
                    </p>
                    {" "}
                ...
                <div className="tk-photos" id="tkPhotos">
                  ...
                  <div className="tk-stage">
                    {" "}
                    <img className="on" src="/images/tank.jpg" data-src-en="/images/tank.jpg" data-src-ar="/images/tank-ar.jpg" alt="Our yellow suction tanker, marked الشفط میاں مجاری, emptying a manhole" fetchPriority="high" />
                    {" "}
                  </div>
                  {" "}
            ...
            <div className="wrap">
              ...
              <div className="work">
                ...
                <div className="reel" id="reel">
                  {" "}
                  <video id="reelVideo" muted loop playsInline preload="auto" poster="/videos/tanker-poster.jpg" aria-label="Video of our yellow tanker at work">
